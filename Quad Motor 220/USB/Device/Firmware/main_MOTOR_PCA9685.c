 ...
 * FileName:    main.c 
 * For Adafruit Motor Shield with PCA9685
 * 
 *
 * 1-15-17: 
...
#define PCA9685_ADDRESS 0b11000000   
    ...
    if (!initializePCA9685(PCA9685_ADDRESS)) printf(">Write error #1\r");
        ...
        setPWM(PCA9685_ADDRESS, RIGHTFRONTPWM, 0, FORWARD);
        setPWM(PCA9685_ADDRESS, LEFTFRONTPWM, 0, FORWARD);
        setPWM(PCA9685_ADDRESS, LEFTREARPWM, 0, FORWARD);
        setPWM(PCA9685_ADDRESS, RIGHTREARPWM, 0, FORWARD);    
    }   
    */
